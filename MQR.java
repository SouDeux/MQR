...
public class MQR {
    ...
    do {
        ...
        while (true){
            System.out.println("pretende jogar mais de um dado? (s/n):");
            String skii = s.next();
        ...
        if (mult) {
            System.out.println("Digite a quantidade de dados que deseja: ");
            qntdados = s.nextInt();
        ...
        while (true){
            System.out.println("Digite a quantidade de lados que deseja: ");
            ...
            if (lados > 1) {  // checa se tem mais de 0 lados
                ...
                media = soma / maximo;
                if (mult){
                    System.out.print("com a soma: " + soma + ", sendo a media: " + ( (double)soma / qntdados) + ". ");
                }
